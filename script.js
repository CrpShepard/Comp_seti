...
function renderTableRows(rows) {
    let s = "<tr><td>" + data[0][0] + "</td><td>" + data[0][1].toString()
     + "</td><td>" + data[1][0] + "</td><td>" + data[1][1].toString()
     + "</td><td>" + data[2][0] + "</td><td>" + data[2][1].toString()
     + "</td><td>" + data[3][0] + "</td><td>" + data[3][1].toString() + "</td></tr>";
...
const getUserInfo = block => {
    let s = "Пользователю " + block[0] + " - " + block[1].toString() + " лет.";
    return s;
  }
